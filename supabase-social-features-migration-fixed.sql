-- ============================================
-- SOCIAL FEATURES MIGRATION (FIXED)
...
-- ============================================
-- COMMENTS TABLE - Update existing or create new
-- ============================================
...
BEGIN
  ...
  -- Add edited if it doesn't exist
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns 
...
BEGIN
  ...
  LOOP
    rank_position := 0;
    -- Get top 3 entries for this contest based on reactions
    FOR entry_record IN
